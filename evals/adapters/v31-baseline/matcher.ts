// @ts-nocheck
/**
 * FROZEN BASELINE REPLICA — DO NOT EDIT BY HAND
 *
 * Verbatim extraction from supabase/functions/calculate-match-v3-1/index.ts
 * at commit c966bd236dafbfb278d2b8e7ea7ee487536e0fbc.
 * Omitted: lines 1-4 (Deno imports) and lines 592-713 (serve() handler + DB access).
 * Everything between the segment markers below is byte-identical to the source;
 * evals/adapters/v31-baseline/drift.test.ts enforces this and fails when the
 * live matcher changes, forcing an explicit baseline/eval decision.
 */
// >>> BEGIN VERBATIM SEGMENT 1 (source lines 5-591)
const corsHeaders = {
...
// >>> SEAM (source lines 592-713 omitted: serve() handler and DB access)
// ============================================
// CONFIG BUILDER
// ============================================
...
// >>> END VERBATIM SEGMENT 2 (source lines 714-EOF)

// ============================================
// BASELINE EXPORTS (appended; not part of the original file)
// ============================================
export function setSynonymMap(map: Map<string, Set<string>>) {
  globalSynonymMap = map;
}
export {
  TECH_DOMAINS,
