...
const SignReturn = lazy(() => import("./pages/intake/SignReturn"));
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/aufnahme/unterschrift-fertig" element={<Suspense fallback={<RouteFallback />}><SignReturn /></Suspense>} />
