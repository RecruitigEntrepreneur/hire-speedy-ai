    ...
    <div className="space-y-6">
      ...
      <div className="bg-muted/50 border rounded-lg p-4 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h4 className="font-medium">Triple-Blind Datenschutz</h4>
        </div>
        
        <ul className="space-y-2 text-sm">
          <li className="flex items-start gap-2">
            <CheckCircle className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
            <span>Kandidat erhält anonyme Einladung</span>
          </li>
          <li className="flex items-start gap-2">
            <CheckCircle className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
            <span>Firmenname wird als "[Branche] Unternehmen" angezeigt</span>
          </li>
          <li className="flex items-start gap-2">
            <CheckCircle className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
            <span>Erst bei Zustimmung werden alle Daten freigegeben</span>
          </li>
        </ul>
      </div>
