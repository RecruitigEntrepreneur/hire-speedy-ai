...
const faqs = [
  { question: "Wie schnell bekomme ich Kandidaten?", answer: "Im Durchschnitt erhalten Sie innerhalb von 48-72 Stunden die ersten qualifizierten Kandidatenvorschläge. Unser Netzwerk von über 12.000 verifizierten Recruitern arbeitet sofort nach Freischaltung Ihrer Stellenanzeige an passenden Matches." },
  { question: "Wie sicher sind meine Daten und die der Kandidaten?", answer: "Maximale Sicherheit ist unser Standard. Wir sind DSGVO-konform, nutzen End-to-End-Verschlüsselung, speichern alle Daten ausschließlich in EU-Rechenzentren und setzen auf Triple-Blind-Anonymisierung. Regelmäßige Security-Audits garantieren die Einhaltung höchster Sicherheitsstandards." },
  ...
  { question: "Kann ich die Plattform mit meinem ATS integrieren?", answer: "Ja, wir bieten native Integrationen mit allen gängigen ATS-Systemen wie Personio, Greenhouse, Lever, Workday und BambooHR. Weitere Integrationen sind auf Anfrage möglich. So bleiben alle Daten synchron und Sie können in Ihrer gewohnten Umgebung arbeiten." },
];
