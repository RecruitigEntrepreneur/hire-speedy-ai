    ...
    <section id="how-it-works" className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-4 relative">
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                {/* Step Card */}
                <div className="bg-white rounded-2xl p-8 border border-slate-200 hover:border-emerald/30 hover:shadow-xl transition-all duration-300 h-full">
                  {/* Step Number Badge */}
                  <div className="relative mb-8">
                    ...
                    <span className="absolute -top-2 -right-2 lg:left-12 lg:right-auto w-8 h-8 rounded-full bg-slate-900 text-white text-sm font-bold flex items-center justify-center">
                      {step.number}
                    </span>
                  </div>
        ...
        <div className="text-center mt-16">
          <p className="text-2xl font-semibold text-slate-500 mb-8">
