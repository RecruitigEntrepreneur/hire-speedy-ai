/**
 * Domain-Normalisierung und Freemail-Erkennung (Browser-Seite).
 *
 ...
 *
 * Spiegelbild von supabase/functions/_shared/domain.ts — beide Dateien muessen
 * dieselbe Antwort geben. Deno kann nicht aus src/ importieren, deshalb die
 * Doppelung. Hier dient sie nur der sofortigen Rueckmeldung im Formular; die
 * verbindliche Pruefung passiert immer serverseitig.
 */
