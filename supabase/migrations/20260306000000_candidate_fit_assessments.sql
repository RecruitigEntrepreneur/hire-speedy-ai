...
-- Replaces keyword-based matching with deep semantic understanding

CREATE TABLE public.candidate_fit_assessments (
  id                        UUID PRIMARY KEY DEFAULT gen_random_uuid(),

  -- Foreign keys (submission = one candidate+job pair)
  ...
  -- Structured assessments (JSONB arrays/objects)
