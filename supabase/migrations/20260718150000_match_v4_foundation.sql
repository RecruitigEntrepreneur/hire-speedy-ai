-- ============================================
-- MATCH V4 FOUNDATION (additiv, Phase 2)
-- 1. match_events: saubere Lern-Schleife (Interaktionen + Modell-Outputs),
--    mit is_synthetic-Flag von Tag 1 (Lehre aus den 9.188 verschmutzten
--    match_outcomes-Zeilen).
-- 2. match_ai_judgements: Pair-Level-Cache für den evidenzbasierten LLM-Judge.
-- 3. jobs.requirements_normalized_*: Stempel des Anforderungs-Normalizers
--    (der Normalizer schreibt nach job_skill_requirements — die der
--    Live-Matcher V3.1 bereits nativ liest).
-- Bewusst NICHT enthalten: kein Schreiben nach jobs.required_languages
-- (würde den Language-Hard-Kill scharf schalten, solange
-- candidates.language_skills leer ist — bekannte Landmine).
-- ============================================
